...
public class OrdersSubmitDTO implements Serializable {
    ...
    //付款方式, 默认为1：微信支付
    @ApiModelProperty(value = "支付方式（1:微信 2:支付宝）", allowableValues = "1, 2", required = true)
    ...
    //配送状态  1立即送出  0选择具体时间
    @ApiModelProperty(value = "配送状态（0:选择具体时间 1:立即送出）", allowableValues = "0, 1", required = true)
    ...
    @ApiModelProperty(value = "餐具数量状态（0:选择具体数量 1:按餐量提供）", allowableValues = "0,1", required = true)

...
public class GlobalExceptionHandler {
    ...
    public Result<String> handleValidationExceptions(MethodArgumentNotValidException ex) {
        ...
        log.error("异常信息：{} 中 {} 传值有误", errorObjectName, errorField);
        return Result.error(ex.getBindingResult().getAllErrors().getFirst().getDefaultMessage());
    }
    ...
    public Result<String> exceptionHandler(HttpMessageNotReadableException exception) {
        ...
        } else if (throwable instanceof StreamReadException) {
    ...
    public Result<String> exceptionHandler(MethodArgumentTypeMismatchException exception) {
        ...
        log.error("异常信息：{}类型不匹配, 期望类型为：{}", name, requiredTypeName);

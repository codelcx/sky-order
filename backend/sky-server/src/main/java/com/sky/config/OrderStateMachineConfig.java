...
@Slf4j
class OrderStateMachineConfig extends EnumStateMachineConfigurerAdapter<OrderStatus, OrderEvent> {
    @Override
    ...
    public void configure(StateMachineTransitionConfigurer<OrderStatus, OrderEvent> transitions) throws Exception {
        transitions
                .withExternal()
                    ...
                    .target(OrderStatus.TO_BE_CONFIRMED)
                ...
                .withExternal()
                    ...
                    .source(OrderStatus.PENDING_PAYMENT)
                    .target(OrderStatus.CANCELLED)
                    .event(OrderEvent.ADMIN_CANCEL)
                    .and()
                .withExternal()
                    // 待接单 -> 已接单状态
                    .source(OrderStatus.TO_BE_CONFIRMED)
                ...
                .withExternal()
                    ...
                    .target(OrderStatus.DELIVERY_IN_PROGRESS)
                ...
                .withExternal()
                    // 派送中 -> 已完成状态
                    .source(OrderStatus.DELIVERY_IN_PROGRESS)
